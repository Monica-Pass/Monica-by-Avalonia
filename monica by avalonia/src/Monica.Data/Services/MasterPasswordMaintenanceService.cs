    ...
    ICryptoService cryptoService) : IMasterPasswordMaintenanceService
{
    ...
    [
        ...
        new("bitwarden_pending_operations", "id", "encrypted_payload_json", SecretBucket.Bitwarden, false),
        new("bitwarden_pending_operations", "id", "encrypted_last_error", SecretBucket.Bitwarden, false)
    ];

...
public sealed partial class MainWindowViewModel
{
    ...
    private async Task ImportTotpCsvFileAsync()
    {
        ...
        {
            ReportImportExportFailure("Opening TOTP CSV import failed", "ImportFileSelectionFailed", ex);
        }
    }
    ...
    private async Task ImportAegisJsonFileAsync()
    {
        ...
        {
            ReportImportExportFailure("Opening Aegis JSON import failed", "ImportFileSelectionFailed", ex);
        }
    }

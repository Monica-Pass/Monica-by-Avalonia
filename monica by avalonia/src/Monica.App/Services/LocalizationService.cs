...
public sealed class LocalizationService : ILocalizationService
{
    ...
    public string PaymentAccount => Text();
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["RecycleBinEmptyHint"] = "Deleted vault items will appear here before permanent removal.",
        ["RecycleBinNoSearchResultsFormat"] = "No deleted vault items match “{0}”.",
        ["RecycleBinItemCountFormat"] = "{0} deleted item(s)",
        ["SelectedRecycleBinItemCountFormat"] = "{0} selected",
        ["SelectRecycleBinItems"] = "Select recycle bin items",
        ["SelectAllVisibleRecycleBinItems"] = "Select all visible recycle bin items",
        ["RestoreItem"] = "Restore",
        ["RecycleBinRetention"] = "Automatic cleanup",
        ["RecycleBinRetentionFormat"] = "Automatic cleanup: {0} days",
        ["RecycleBinRemainingDaysFormat"] = "{0} days until automatic cleanup",
        ["RecycleBinCleanupDue"] = "Cleanup due",
        ["RecycleBinCleanupDateUnknown"] = "Cleanup date unavailable",
        ["RecycleBinAutoCleanedFormat"] = "Automatically removed {0} expired recycle bin item(s)",
        ["RecycleBinAutoCleanupFailed"] = "Automatic recycle bin cleanup failed; no additional items were removed.",
        ["RecycleBinRetention7Days"] = "Keep 7 days",
        ["RecycleBinRetention30Days"] = "Keep 30 days",
        ["RecycleBinRetention90Days"] = "Keep 90 days",
        ["RecycleBinRetention365Days"] = "Keep 365 days",
        ["Timeline"] = "Timeline",
        ...
        ["VaultLoadTitle"] = "Loading vault",
        ["VaultLoadPreparing"] = "Preparing the vault...",
        ["VaultLoadReadingData"] = "Reading vault data in the background...",
        ["VaultLoadReadingCoreItems"] = "Reading passwords, notes, and categories...",
        ["VaultLoadProjectingPasswords"] = "Organizing the password list...",
        ["VaultLoadSecureItems"] = "Loading notes and secure items...",
        ["VaultLoadSources"] = "Loading folders and vault sources...",
        ["VaultLoadAuthenticators"] = "Loading authenticator codes...",
        ["VaultLoadReady"] = "Vault ready",
        ...
        ["DeleteSelectedPermanentlyConfirmationTitle"] = "Delete selected items permanently?",
        ["DeleteSelectedPermanentlyConfirmationMessageFormat"] = "Permanently delete the {0} selected item(s)? This cannot be undone.",
        ...
        ["DeleteFolderItemsConfirmationMessageFormat"] = "Delete folder \"{0}\"? {1} vault item(s) will be moved to No folder.",
        ["DeletedFolderItemsFormat"] = "Deleted folder {0}; moved {1} vault item(s) to No folder",
        ...
        ["LoginTypeBarcode"] = "Barcode",
        ["BarcodePayload"] = "Barcode payload",
        ["BarcodeRenderMode"] = "Display mode",
        ["BarcodeRenderQr"] = "QR code",
        ["BarcodeRenderCode128"] = "Code 128",
        ...
        ["TotpQrInvalidImage"] = "No supported authenticator QR code was found in the selected image.",
        ["TotpQrDecodeFailed"] = "Could not scan the authenticator QR image.",
        ...
        ["TotpCounter"] = "Counter",
        ["GenerateNextTotp"] = "Generate next code",
        ["GeneratedNextTotpFormat"] = "Generated the next code for {0}.",
        ["TotpDeleteDescription"] = "Move this authenticator to the recycle bin. It can be restored later.",
        ...
        ["WalletDeleteDescription"] = "Move this wallet item to the recycle bin. It can be restored later.",
        ...
        ["DefaultPaymentAddress"] = "Use as default",
        ["PaymentProvider"] = "Provider",
        ["AccountName"] = "Account name",
        ["AccountHolderName"] = "Account holder",
        ["AccountId"] = "Account ID",
        ["MaskedAccountNumber"] = "Masked account number",
        ["LinkedCardLast4"] = "Linked card last four digits",
        ["RoutingNumber"] = "Routing number",
        ["Iban"] = "IBAN",
        ["SwiftBic"] = "SWIFT / BIC",
        ["Currency"] = "Currency",
        ["PaymentTypeDigitalWallet"] = "Digital wallet",
        ["PaymentTypeBankAccount"] = "Bank account",
        ["PaymentTypePaymentApp"] = "Payment app",
        ["PaymentTypeBuyNowPayLater"] = "Buy now, pay later",
        ["PaymentTypeCryptoWallet"] = "Crypto wallet",
        ["StreetAddressRequired"] = "Enter a street address.",
        ["PaymentProviderRequired"] = "Enter a payment provider.",
        ["CardBrand"] = "Brand",
        ...
        ["ChangeMasterPasswordFailed"] = "Could not update the master password. Try again.",
        ["SecurityQuestionAnswersRequired"] = "Enter both security-question answers.",
        ["SecurityQuestionTextRequired"] = "Enter text for both custom security questions.",
        ["SecurityQuestionsMustDiffer"] = "Choose two different security questions.",
        ...
        ["ResetMasterPasswordFailed"] = "Could not reset the master password. Verify the recovery details and try again.",
        ...
        ["SecurityQuestionsSaveFailed"] = "Could not save the security questions. Review the entries and try again.",
        ["Desktop"] = "Desktop",
        ["DesktopSettingsDescription"] = "Choose how Monica stays available, opens from anywhere, pairs with your browser, and uses desktop space.",
        ["DesktopBackgroundBehavior"] = "Background behavior",
        ["DesktopBackgroundBehaviorDescription"] = "Decide whether Monica remains available from the Windows notification area after its window closes.",
        ["DesktopQuickAccess"] = "Quick access",
        ["DesktopQuickAccessDescription"] = "Open Monica from anywhere with a system-wide shortcut that follows Windows keyboard conventions.",
        ["DesktopDensityAndAppearance"] = "Density and appearance",
        ["DesktopDensityAndAppearanceDescription"] = "Adjust how much vault information fits on screen without changing the stored data.",
        ...
        ["QuickSearchStatusUnavailableTitle"] = "Quick search is unavailable",
        ["QuickSearchStatusDisabledTitle"] = "Global quick search is off",
        ["QuickSearchStatusDisabledDescription"] = "Enable quick search to register a system-wide keyboard shortcut.",
        ["QuickSearchStatusActiveTitle"] = "Global shortcut is ready",
        ["QuickSearchStatusActiveDescriptionFormat"] = "Press {0} from another app to bring Monica's quick search forward.",
        ["QuickSearchStatusErrorTitle"] = "The shortcut needs attention",
        ["BrowserExtensionPairing"] = "Browser extension pairing",
        ["BrowserExtensionPairingDescription"] = "Connect the extension to Monica's authenticated loopback service without exposing the vault to the network.",
        ...
        ["BrowserBridgeStateUnavailableTitle"] = "Browser pairing is unavailable",
        ["BrowserBridgeStateDisabledTitle"] = "Browser pairing is off",
        ["BrowserBridgeStateDisabledDescription"] = "No local listener is running and no extension token is active.",
        ["BrowserBridgeStateWaitingTitle"] = "Waiting for the vault to unlock",
        ["BrowserBridgeStateWaitingDescription"] = "Monica starts the bridge only while the vault is unlocked and revokes access again when it locks.",
        ["BrowserBridgeStateStartingTitle"] = "Starting the local bridge",
        ["BrowserBridgeStateStartingDescriptionFormat"] = "Preparing the authenticated loopback listener on 127.0.0.1:{0}.",
        ["BrowserBridgeStateRunningTitle"] = "Ready to pair",
        ["BrowserBridgeStateRunningDescriptionFormat"] = "The bridge is listening only on 127.0.0.1:{0}. Use the temporary token below to pair the extension.",
        ["BrowserBridgeStateErrorTitle"] = "The browser bridge could not start",
        ["BrowserBridgeEndpointFormat"] = "Local endpoint: http://127.0.0.1:{0}",
        ["BrowserPairingSecurityNoticeTitle"] = "Local and temporary by design",
        ["BrowserPairingSecurityNoticeMessage"] = "The bridge accepts authenticated requests only from the local device. Monica revokes the temporary token immediately when you lock the vault, turn the bridge off, change its port, or exit.",
        ["BrowserPairingAccessTitle"] = "Temporary pairing access",
        ["BrowserPairingAccessDescription"] = "Copy the hidden token into the browser extension. The token itself is never shown on this page.",
        ["BrowserPairingHiddenToken"] = "Hidden temporary browser pairing token",
        ["BrowserPairingCopyHelp"] = "Copies the temporary token through Monica's protected clipboard path.",
        ...
        ["BitwardenOnlineVault"] = "Bitwarden online vault",
        ["BitwardenOnlineVaultDescription"] = "Connect Bitwarden accounts, review synchronization health, and control transfers from one desktop surface.",
        ["BitwardenUnavailable"] = "Bitwarden online synchronization is unavailable in this application host.",
        ["BitwardenLoadingAccounts"] = "Loading Bitwarden accounts...",
        ["BitwardenNoAccounts"] = "No Bitwarden account is connected.",
        ["BitwardenAccountCountFormat"] = "{0} Bitwarden account(s)",
        ["BitwardenAccounts"] = "Connected accounts",
        ["BitwardenAccountsDescription"] = "Select an account to inspect its server, pending changes, conflicts, and last synchronization.",
        ["BitwardenSelectAccount"] = "Select an account",
        ["BitwardenAddAccount"] = "Add account",
        ["BitwardenRefreshAccounts"] = "Refresh accounts",
        ["BitwardenAccountStatus"] = "Account status",
        ["BitwardenAccountStatusDescription"] = "Synchronization is manual until a background policy is enabled. Monica never transfers data while the main vault is locked.",
        ["BitwardenConnectAccount"] = "Connect or reconnect",
        ["BitwardenConnectAccountDescription"] = "Credentials are used only for authentication and are cleared from the form after the operation.",
        ["BitwardenConnectionDetails"] = "Connection details",
        ["BitwardenConnectionDetailsDescription"] = "Use an official Bitwarden region or an HTTPS self-hosted server.",
        ["BitwardenServerUrl"] = "Server address",
        ["BitwardenServerUrlDescription"] = "Official US: https://vault.bitwarden.com/ · EU: https://vault.bitwarden.eu/",
        ["BitwardenEmail"] = "Email address",
        ["BitwardenMasterPassword"] = "Bitwarden master password",
        ["BitwardenMasterPasswordDescription"] = "Monica derives the account keys locally and never logs this password.",
        ["BitwardenConnect"] = "Connect",
        ["Continue"] = "Continue",
        ["BitwardenCancelConnection"] = "Cancel connection",
        ["BitwardenSecurityNoticeTitle"] = "Protected authentication",
        ["BitwardenSecurityNoticeMessage"] = "Only HTTPS endpoints are accepted. Tokens and vault keys are encrypted in Monica storage; temporary form secrets are cleared after success, cancellation, or vault lock.",
        ["BitwardenTwoFactorTitle"] = "Two-step login required",
        ["BitwardenTwoFactorDescription"] = "Choose the method requested by Bitwarden and enter the verification code.",
        ["BitwardenTwoFactorMethod"] = "Verification method",
        ["BitwardenTwoFactorToken"] = "Verification code",
        ["BitwardenRememberTwoFactor"] = "Remember this device",
        ["BitwardenCaptchaTitle"] = "Captcha verification required",
        ["BitwardenCaptchaDescription"] = "Complete the Bitwarden captcha challenge, then paste its response token.",
        ["BitwardenCaptchaSiteKey"] = "Captcha site key",
        ["BitwardenCaptchaResponse"] = "Captcha response",
        ["BitwardenNewDeviceTitle"] = "New device verification required",
        ["BitwardenNewDeviceDescription"] = "Enter the one-time code sent by Bitwarden for this device.",
        ["BitwardenNewDeviceOtp"] = "One-time verification code",
        ["BitwardenInvalidCredentialsTitle"] = "Sign-in details were not accepted",
        ["BitwardenInvalidCredentialsDescription"] = "Check the email address and master password, then try again.",
        ["BitwardenRejectedTitle"] = "Bitwarden rejected the sign-in",
        ["BitwardenRejectedDescription"] = "Review the account or server requirements before trying again.",
        ["BitwardenConnected"] = "Connected",
        ["BitwardenDisconnected"] = "Disconnected",
        ["BitwardenNeverSynced"] = "Never synchronized",
        ["BitwardenLastSyncFormat"] = "Last synchronized {0}",
        ["BitwardenNoConflicts"] = "No unresolved conflicts",
        ["BitwardenConflictCountFormat"] = "{0} unresolved conflict(s)",
        ["BitwardenNeedsAttention"] = "Synchronization needs attention",
        ["BitwardenReadyToSync"] = "Ready to synchronize",
        ["BitwardenReconnectRequired"] = "Reconnect to resume synchronization",
        ["BitwardenSyncNow"] = "Sync now",
        ["BitwardenReconnect"] = "Reconnect",
        ["BitwardenDisconnect"] = "Disconnect",
        ["BitwardenDisconnectTitle"] = "Disconnect Bitwarden account?",
        ["BitwardenDisconnectMessageFormat"] = "Disconnect {0}? Monica will remove the stored Bitwarden session secrets, but already imported local items will remain.",
        ["BitwardenDisconnectedFormat"] = "Disconnected Bitwarden account {0}.",
        ["BitwardenDisconnectFailed"] = "The Bitwarden account could not be disconnected.",
        ["BitwardenConnectedFormat"] = "Connected Bitwarden account {0}.",
        ["BitwardenSyncedFormat"] = "Synchronized Bitwarden account {0}.",
        ...
        ["BitwardenAuthenticationFailed"] = "Bitwarden authentication could not be completed. Check the account, server, and network connection.",
        ["BitwardenSecureConnectionRequired"] = "Use a valid HTTPS Bitwarden server address without embedded credentials, query parameters, or fragments.",
        ["BitwardenOperationInProgress"] = "Another Bitwarden operation is already in progress.",
        ["BitwardenOperationCanceled"] = "The Bitwarden operation was canceled.",
        ["BitwardenRequiresUnlockedVault"] = "Unlock the Monica vault before connecting or synchronizing Bitwarden.",
        ["BitwardenSyncPreparing"] = "Preparing Bitwarden synchronization...",
        ["BitwardenSyncRefreshingToken"] = "Refreshing the Bitwarden session...",
        ["BitwardenSyncUploading"] = "Uploading local changes...",
        ["BitwardenSyncDownloading"] = "Downloading the encrypted Bitwarden vault...",
        ["BitwardenSyncApplying"] = "Applying remote changes locally...",
        ["BitwardenSyncCompleted"] = "Bitwarden synchronization completed.",
        ["BitwardenSyncFailed"] = "Bitwarden synchronization failed. Review the account status and try again.",
        ["OneDrive"] = "OneDrive",
        ...
        ["MdbxRemoteConflictDetected"] = "A remote conflict was detected. Local and remote copies were preserved; choose which copy to keep.",
        ["MdbxSyncFailed"] = "MDBX synchronization failed. Check the source and try again.",
        ["MdbxOneDriveSyncFailed"] = "OneDrive MDBX synchronization failed. Check the account and connection, then try again.",
        ["MdbxOneDriveAccountRequired"] = "Sign in to the Microsoft account linked to this MDBX source, then try again.",
        ["MdbxWebDavSyncFailed"] = "WebDAV MDBX synchronization failed. Check the connection and try again.",
        ...
        ["OneDriveConnectionFailed"] = "Could not connect to OneDrive. Check the account and network connection, then try again.",
        ["WebDavConnectionTestSucceededFormat"] = "WebDAV connection test succeeded; {0} remote item(s) are visible.",
        ["WebDavConnectionTestFailed"] = "Could not connect to WebDAV. Check the server address and credentials, then try again.",
        ...
        ["WebDavBackupHistoryFailed"] = "Could not load WebDAV backup history. Check the connection and try again.",
        ...
        ["WebDavBackupInvalidPayload"] = "This is not a valid encrypted Monica backup. Choose another backup file.",
        ["WebDavBackupUnsupportedVersion"] = "This Monica backup uses an unsupported encryption version. Update Monica or choose a compatible backup.",
        ["WebDavBackupUnsupportedKdf"] = "This Monica backup uses an unsupported key-derivation method. Choose a compatible backup.",
        ["WebDavBackupUnsupportedIterations"] = "This Monica backup uses unsupported key-derivation settings. Choose a compatible backup.",
        ["WebDavBackupInvalidParameters"] = "The Monica backup contains invalid encryption parameters. Choose another backup file.",
        ["WebDavBackupInvalidCiphertext"] = "The Monica backup contains invalid encrypted data. Choose another backup file.",
        ["WebDavBackupDecryptionFailed"] = "Could not decrypt the Monica backup. Check the backup password and try again.",
        ...
        ["CreateWebDavBackupFailed"] = "Could not create the WebDAV backup. Check the connection and try again.",
        ["RestoredWebDavBackupFormat"] = "Restored WebDAV backup {0}: {1} passwords, {2} secure items and {3} folders imported.",
        ["RestoreWebDavBackupFailed"] = "Could not restore the WebDAV backup. Check the connection and backup password, then try again.",
        ["DeletedWebDavBackupFormat"] = "Deleted WebDAV backup {0}.",
        ["DeleteWebDavBackupFailed"] = "Could not delete the WebDAV backup. Check the connection and try again.",
        ...
        ["SettingsSaveFailed"] = "Could not save settings. Check that Monica can write to its app-data folder and try again.",
        ...
        ["RestoredRecycleBinItemFormat"] = "Restored {0}",
        ...
        ["RestoredSelectedRecycleBinItemsFormat"] = "Restored {0} selected item(s)",
        ...
        ["DeletedRecycleBinItemPermanentlyFormat"] = "Permanently deleted {0}",
        ["DeletedSelectedPasswordsPermanentlyFormat"] = "Permanently deleted {0} selected passwords",
        ["DeletedSelectedRecycleBinItemsPermanentlyFormat"] = "Permanently deleted {0} selected item(s)",
        ...
        ["SaveExportFileFailed"] = "The export file could not be saved. Check the destination and try again.",
        ["SaveExportFileFailedFormat"] = "Save export failed: {0}",
        ["ImportFileSelectionFailed"] = "The import file could not be opened. Check access to the file and try again.",
        ["ImportInvalidFormat"] = "The selected file is not a valid Monica export.",
        ["ImportCsvInvalidFormat"] = "The selected CSV file does not contain a supported header row.",
        ["ImportResourceLimitExceeded"] = "The import file is too large or complex to process safely.",
        ["ImportUnexpectedFailure"] = "The import could not be completed. Check the file and try again.",
        ...
        ["MdbxOperationFailed"] = "Could not complete the MDBX operation. Check the connection and local working copy, then try again.",
        ...
        ["ClearVaultDataFailed"] = "Could not clear the selected vault data. The operation was stopped; try again.",
    ...
    private static readonly Dictionary<string, string> Chinese = new()
    {
        ...
        ["RecycleBinEmptyHint"] = "删除的保险库项目会先显示在这里，确认后才会永久移除。",
        ["RecycleBinNoSearchResultsFormat"] = "没有与“{0}”匹配的已删除保险库项目。",
        ["RecycleBinItemCountFormat"] = "{0} 个已删除项目",
        ["SelectedRecycleBinItemCountFormat"] = "已选择 {0} 个项目",
        ["SelectRecycleBinItems"] = "选择回收站项目",
        ["SelectAllVisibleRecycleBinItems"] = "选择当前显示的所有回收站项目",
        ["RestoreItem"] = "恢复",
        ["RecycleBinRetention"] = "自动清理",
        ["RecycleBinRetentionFormat"] = "自动清理：{0} 天",
        ["RecycleBinRemainingDaysFormat"] = "距离自动清理还有 {0} 天",
        ["RecycleBinCleanupDue"] = "已到清理时间",
        ["RecycleBinCleanupDateUnknown"] = "无法计算清理时间",
        ["RecycleBinAutoCleanedFormat"] = "已自动清理 {0} 个过期回收站项目",
        ["RecycleBinAutoCleanupFailed"] = "回收站自动清理失败，未继续移除其他项目。",
        ["RecycleBinRetention7Days"] = "保留 7 天",
        ["RecycleBinRetention30Days"] = "保留 30 天",
        ["RecycleBinRetention90Days"] = "保留 90 天",
        ["RecycleBinRetention365Days"] = "保留 365 天",
        ["Timeline"] = "时间线",
        ...
        ["VaultLoadTitle"] = "正在加载保险库",
        ["VaultLoadPreparing"] = "正在准备保险库...",
        ["VaultLoadReadingData"] = "正在后台读取保险库数据...",
        ["VaultLoadReadingCoreItems"] = "正在读取密码、笔记和分类...",
        ["VaultLoadProjectingPasswords"] = "正在整理密码列表...",
        ["VaultLoadSecureItems"] = "正在加载笔记和安全项目...",
        ["VaultLoadSources"] = "正在加载文件夹和保险库源...",
        ["VaultLoadAuthenticators"] = "正在加载验证码...",
        ["VaultLoadReady"] = "保险库已就绪",
        ...
        ["DeleteSelectedPermanentlyConfirmationTitle"] = "永久删除选中的项目？",
        ["DeleteSelectedPermanentlyConfirmationMessageFormat"] = "要永久删除选中的 {0} 个项目吗？此操作无法撤销。",
        ...
        ["DeleteFolderItemsConfirmationMessageFormat"] = "要删除文件夹“{0}”吗？{1} 个保险库项目会移动到无文件夹。",
        ["DeletedFolderItemsFormat"] = "已删除文件夹 {0}；{1} 个保险库项目已移动到无文件夹",
        ...
        ["LoginTypeBarcode"] = "条码",
        ["BarcodePayload"] = "条码内容",
        ["BarcodeRenderMode"] = "显示模式",
        ["BarcodeRenderQr"] = "二维码",
        ["BarcodeRenderCode128"] = "Code 128 条码",
        ...
        ["TotpQrInvalidImage"] = "所选图片中没有找到受支持的验证器二维码。",
        ["TotpQrDecodeFailed"] = "无法扫描验证器二维码图片。",
        ["TotpFilterTitle"] = "分组",
        ...
        ["TotpAlgorithm"] = "算法",
        ["TotpCounter"] = "计数器",
        ["GenerateNextTotp"] = "生成下一码",
        ["GeneratedNextTotpFormat"] = "已为 {0} 生成下一码。",
        ["TotpDeleteDescription"] = "将此验证器移到回收站，之后仍可恢复。",
        ["MoreActions"] = "更多操作",
        ["ShowHidden"] = "显示隐藏项",
        ["Help"] = "帮助",
        ...
        ["WalletDeleteDescription"] = "将此卡包项目移到回收站，之后仍可恢复。",
        ...
        ["StreetAddress"] = "街道地址",
        ["Apartment"] = "公寓或单元",
        ["StateProvince"] = "省、州或地区",
        ["PostalCode"] = "邮政编码",
        ["DefaultPaymentAddress"] = "设为默认",
        ["PaymentProvider"] = "服务商",
        ["AccountName"] = "账户名称",
        ["AccountHolderName"] = "账户持有人",
        ["AccountId"] = "账户 ID",
        ["MaskedAccountNumber"] = "掩码账户号",
        ["LinkedCardLast4"] = "关联卡号后四位",
        ["RoutingNumber"] = "银行路由号",
        ["Iban"] = "IBAN",
        ["SwiftBic"] = "SWIFT / BIC",
        ["Currency"] = "币种",
        ["PaymentTypeDigitalWallet"] = "数字钱包",
        ["PaymentTypeBankAccount"] = "银行账户",
        ["PaymentTypePaymentApp"] = "支付应用",
        ["PaymentTypeBuyNowPayLater"] = "先买后付",
        ["PaymentTypeCryptoWallet"] = "加密货币钱包",
        ["StreetAddressRequired"] = "请输入街道地址。",
        ["PaymentProviderRequired"] = "请输入支付服务商。",
        ["CardBrand"] = "卡组织",
        ["DocumentPhotos"] = "证件照片",
        ...
        ["ChangeMasterPasswordFailed"] = "无法更新主密码，请重试。",
        ["SecurityQuestionAnswersRequired"] = "请输入两个密保答案。",
        ["SecurityQuestionTextRequired"] = "请填写两个自定义密保问题的内容。",
        ["SecurityQuestionsMustDiffer"] = "请选择两个不同的密保问题。",
        ...
        ["ResetMasterPasswordFailed"] = "无法重设主密码，请检查找回信息后重试。",
        ...
        ["SecurityQuestionsSaveFailed"] = "无法保存密保问题，请检查输入后重试。",
        ["Desktop"] = "桌面",
        ["DesktopSettingsDescription"] = "设置 Monica 在 Windows 后台驻留、全局唤起、浏览器配对以及桌面空间利用方式。",
        ["DesktopBackgroundBehavior"] = "桌面后台行为",
        ["DesktopBackgroundBehaviorDescription"] = "决定关闭窗口后是否仍从 Windows 通知区域保留 Monica 入口。",
        ["DesktopQuickAccess"] = "快速访问",
        ["DesktopQuickAccessDescription"] = "按照 Windows 键盘操作习惯，通过系统级快捷键从其他应用随时唤起 Monica。",
        ["DesktopDensityAndAppearance"] = "密度与外观",
        ["DesktopDensityAndAppearanceDescription"] = "调整屏幕中可见的保险库信息密度，不改变任何已存储数据。",
        ...
        ["QuickSearchStatusUnavailableTitle"] = "快速搜索不可用",
        ["QuickSearchStatusDisabledTitle"] = "全局快速搜索已关闭",
        ["QuickSearchStatusDisabledDescription"] = "启用快速搜索后，Monica 才会注册系统级键盘快捷键。",
        ["QuickSearchStatusActiveTitle"] = "全局快捷键已就绪",
        ["QuickSearchStatusActiveDescriptionFormat"] = "在其他应用中按 {0}，即可将 Monica 快速搜索调到前台。",
        ["QuickSearchStatusErrorTitle"] = "快捷键需要处理",
        ["BrowserExtensionPairing"] = "浏览器扩展配对",
        ["BrowserExtensionPairingDescription"] = "通过带身份验证的本机回环服务连接扩展，不把保险库暴露到网络。",
        ...
        ["BrowserBridgeStateUnavailableTitle"] = "浏览器配对不可用",
        ["BrowserBridgeStateDisabledTitle"] = "浏览器配对已关闭",
        ["BrowserBridgeStateDisabledDescription"] = "当前没有本地监听服务，也没有有效的扩展令牌。",
        ["BrowserBridgeStateWaitingTitle"] = "正在等待保险库解锁",
        ["BrowserBridgeStateWaitingDescription"] = "Monica 只会在保险库解锁期间启动桥接，重新锁定后会立即撤销访问。",
        ["BrowserBridgeStateStartingTitle"] = "正在启动本地桥接",
        ["BrowserBridgeStateStartingDescriptionFormat"] = "正在 127.0.0.1:{0} 准备带身份验证的回环监听服务。",
        ["BrowserBridgeStateRunningTitle"] = "可以开始配对",
        ["BrowserBridgeStateRunningDescriptionFormat"] = "桥接仅监听 127.0.0.1:{0}。请使用下方临时令牌配对浏览器扩展。",
        ["BrowserBridgeStateErrorTitle"] = "浏览器桥接无法启动",
        ["BrowserBridgeEndpointFormat"] = "本地端点：http://127.0.0.1:{0}",
        ["BrowserPairingSecurityNoticeTitle"] = "仅限本机，并且令牌是临时的",
        ["BrowserPairingSecurityNoticeMessage"] = "桥接只接受本机发出的已验证请求。锁定保险库、关闭桥接、修改端口或退出 Monica 时，临时令牌都会立即失效。",
        ["BrowserPairingAccessTitle"] = "临时配对访问",
        ["BrowserPairingAccessDescription"] = "将隐藏令牌复制到浏览器扩展；本页面不会直接显示令牌内容。",
        ["BrowserPairingHiddenToken"] = "已隐藏的浏览器临时配对令牌",
        ["BrowserPairingCopyHelp"] = "通过 Monica 的受保护剪贴板流程复制临时令牌。",
        ...
        ["BitwardenOnlineVault"] = "Bitwarden 在线保险库",
        ["BitwardenOnlineVaultDescription"] = "在一个桌面页面中连接 Bitwarden 账户、查看同步健康状态并控制数据传输。",
        ["BitwardenUnavailable"] = "当前应用宿主不支持 Bitwarden 在线同步。",
        ["BitwardenLoadingAccounts"] = "正在加载 Bitwarden 账户…",
        ["BitwardenNoAccounts"] = "尚未连接 Bitwarden 账户。",
        ["BitwardenAccountCountFormat"] = "{0} 个 Bitwarden 账户",
        ["BitwardenAccounts"] = "已连接账户",
        ["BitwardenAccountsDescription"] = "选择账户以查看服务器、待上传变更、冲突和最近同步时间。",
        ["BitwardenSelectAccount"] = "选择账户",
        ["BitwardenAddAccount"] = "添加账户",
        ["BitwardenRefreshAccounts"] = "刷新账户",
        ["BitwardenAccountStatus"] = "账户状态",
        ["BitwardenAccountStatusDescription"] = "启用后台策略前同步由你手动触发；Monica 主保险库锁定时绝不会传输数据。",
        ["BitwardenConnectAccount"] = "连接或重新连接",
        ["BitwardenConnectAccountDescription"] = "凭据仅用于认证，操作完成后会从表单中清除。",
        ["BitwardenConnectionDetails"] = "连接信息",
        ["BitwardenConnectionDetailsDescription"] = "可使用 Bitwarden 官方区域或 HTTPS 自托管服务器。",
        ["BitwardenServerUrl"] = "服务器地址",
        ["BitwardenServerUrlDescription"] = "美国官方：https://vault.bitwarden.com/ · 欧洲官方：https://vault.bitwarden.eu/",
        ["BitwardenEmail"] = "邮箱地址",
        ["BitwardenMasterPassword"] = "Bitwarden 主密码",
        ["BitwardenMasterPasswordDescription"] = "Monica 只在本机派生账户密钥，绝不会记录此密码。",
        ["BitwardenConnect"] = "连接",
        ["Continue"] = "继续",
        ["BitwardenCancelConnection"] = "取消连接",
        ["BitwardenSecurityNoticeTitle"] = "受保护的认证流程",
        ["BitwardenSecurityNoticeMessage"] = "只允许 HTTPS 端点。令牌和保险库密钥会加密保存；临时表单机密会在成功、取消或主保险库锁定时清除。",
        ["BitwardenTwoFactorTitle"] = "需要两步登录验证",
        ["BitwardenTwoFactorDescription"] = "选择 Bitwarden 要求的验证方式并输入验证码。",
        ["BitwardenTwoFactorMethod"] = "验证方式",
        ["BitwardenTwoFactorToken"] = "验证码",
        ["BitwardenRememberTwoFactor"] = "记住此设备",
        ["BitwardenCaptchaTitle"] = "需要验证码验证",
        ["BitwardenCaptchaDescription"] = "完成 Bitwarden 验证码挑战，然后粘贴响应令牌。",
        ["BitwardenCaptchaSiteKey"] = "验证码站点密钥",
        ["BitwardenCaptchaResponse"] = "验证码响应",
        ["BitwardenNewDeviceTitle"] = "需要验证新设备",
        ["BitwardenNewDeviceDescription"] = "输入 Bitwarden 为此设备发送的一次性验证码。",
        ["BitwardenNewDeviceOtp"] = "一次性验证码",
        ["BitwardenInvalidCredentialsTitle"] = "登录信息未被接受",
        ["BitwardenInvalidCredentialsDescription"] = "请检查邮箱和主密码后重试。",
        ["BitwardenRejectedTitle"] = "Bitwarden 拒绝了此次登录",
        ["BitwardenRejectedDescription"] = "请检查账户或服务器要求后重试。",
        ["BitwardenConnected"] = "已连接",
        ["BitwardenDisconnected"] = "已断开",
        ["BitwardenNeverSynced"] = "从未同步",
        ["BitwardenLastSyncFormat"] = "最近同步：{0}",
        ["BitwardenNoConflicts"] = "没有未解决冲突",
        ["BitwardenConflictCountFormat"] = "{0} 个未解决冲突",
        ["BitwardenNeedsAttention"] = "同步需要处理",
        ["BitwardenReadyToSync"] = "可以同步",
        ["BitwardenReconnectRequired"] = "重新连接后才能继续同步",
        ["BitwardenSyncNow"] = "立即同步",
        ["BitwardenReconnect"] = "重新连接",
        ["BitwardenDisconnect"] = "断开连接",
        ["BitwardenDisconnectTitle"] = "断开 Bitwarden 账户？",
        ["BitwardenDisconnectMessageFormat"] = "要断开 {0} 吗？Monica 会移除保存的 Bitwarden 会话机密，但已导入的本地项目会保留。",
        ["BitwardenDisconnectedFormat"] = "已断开 Bitwarden 账户 {0}。",
        ["BitwardenDisconnectFailed"] = "无法断开 Bitwarden 账户。",
        ["BitwardenConnectedFormat"] = "已连接 Bitwarden 账户 {0}。",
        ["BitwardenSyncedFormat"] = "已同步 Bitwarden 账户 {0}。",
        ["BitwardenConnectedSyncFailed"] = "账户已连接，但首次同步未完成。请使用“立即同步”重试。",
        ["BitwardenLoadAccountsFailed"] = "无法加载 Bitwarden 账户。",
        ["BitwardenAuthenticationFailed"] = "无法完成 Bitwarden 认证，请检查账户、服务器和网络连接。",
        ["BitwardenSecureConnectionRequired"] = "请输入有效的 HTTPS Bitwarden 服务器地址，且不能包含内嵌凭据、查询参数或片段。",
        ["BitwardenOperationInProgress"] = "已有另一个 Bitwarden 操作正在进行。",
        ["BitwardenOperationCanceled"] = "Bitwarden 操作已取消。",
        ["BitwardenRequiresUnlockedVault"] = "连接或同步 Bitwarden 前，请先解锁 Monica 主保险库。",
        ["BitwardenSyncPreparing"] = "正在准备 Bitwarden 同步…",
        ["BitwardenSyncRefreshingToken"] = "正在刷新 Bitwarden 会话…",
        ["BitwardenSyncUploading"] = "正在上传本地变更…",
        ["BitwardenSyncDownloading"] = "正在下载加密的 Bitwarden 保险库…",
        ["BitwardenSyncApplying"] = "正在将远端变更应用到本地…",
        ["BitwardenSyncCompleted"] = "Bitwarden 同步已完成。",
        ["BitwardenSyncFailed"] = "Bitwarden 同步失败，请检查账户状态后重试。",
        ["BackupHistory"] = "备份历史",
        ["BackupNow"] = "立即备份",
        ...
        ["MdbxRemoteConflictDetected"] = "检测到远程冲突，本地和远程副本均已保留，请选择要保留的副本。",
        ["MdbxSyncFailed"] = "MDBX 同步失败，请检查数据源后重试。",
        ["MdbxOneDriveSyncFailed"] = "OneDrive MDBX 同步失败，请检查账户和连接后重试。",
        ["MdbxOneDriveAccountRequired"] = "请登录与此 MDBX 数据源绑定的 Microsoft 账户，然后重试。",
        ["MdbxWebDavSyncFailed"] = "WebDAV MDBX 同步失败，请检查连接后重试。",
        ...
        ["OneDriveConnectionFailed"] = "无法连接 OneDrive，请检查账户和网络连接后重试。",
        ["WebDavConnectionTestSucceededFormat"] = "WebDAV 连接测试成功；可见 {0} 个远程项目。",
        ["WebDavConnectionTestFailed"] = "无法连接 WebDAV，请检查服务器地址和凭据后重试。",
        ...
        ["WebDavBackupHistoryFailed"] = "无法加载 WebDAV 备份历史，请检查连接后重试。",
        ["WebDavBackupSizeLimitExceededFormat"] = "WebDAV 备份超过 Monica 的安全传输上限（{0}）。请移除大型附件或拆分备份后重试。",
        ["WebDavBackupInvalidPayload"] = "这不是有效的 Monica 加密备份，请选择其他备份文件。",
        ["WebDavBackupUnsupportedVersion"] = "此 Monica 备份使用不受支持的加密版本，请更新 Monica 或选择兼容备份。",
        ["WebDavBackupUnsupportedKdf"] = "此 Monica 备份使用不受支持的密钥派生方式，请选择兼容备份。",
        ["WebDavBackupUnsupportedIterations"] = "此 Monica 备份使用不受支持的密钥派生参数，请选择兼容备份。",
        ["WebDavBackupInvalidParameters"] = "此 Monica 备份包含无效的加密参数，请选择其他备份文件。",
        ["WebDavBackupInvalidCiphertext"] = "此 Monica 备份包含无效的加密数据，请选择其他备份文件。",
        ["WebDavBackupDecryptionFailed"] = "无法解密 Monica 备份，请检查备份密码后重试。",
        ...
        ["CreateWebDavBackupFailed"] = "无法创建 WebDAV 备份，请检查连接后重试。",
        ["RestoreWebDavBackupFailed"] = "无法恢复 WebDAV 备份，请检查连接和备份密码后重试。",
        ["DeletedWebDavBackupFormat"] = "已删除 WebDAV 备份 {0}。",
        ["DeleteWebDavBackupFailed"] = "无法删除 WebDAV 备份，请检查连接后重试。",
        ["UnknownDate"] = "未知日期",
        ["UnknownSize"] = "未知大小",
        ...
        ["SettingsSaved"] = "设置已保存",
        ["SettingsSaveFailed"] = "无法保存设置，请检查 Monica 是否可写入应用数据目录后重试。",
        ...
        ["RestoredRecycleBinItemFormat"] = "已恢复 {0}",
        ["DeletedRecycleBinItemPermanentlyFormat"] = "已永久删除 {0}",
        ["UnarchivedSelectedPasswordsFormat"] = "已取消归档选中的 {0} 个密码",
        ["RestoredSelectedPasswordsFormat"] = "已恢复选中的 {0} 个密码",
        ["RestoredSelectedRecycleBinItemsFormat"] = "已恢复选中的 {0} 个项目",
        ["DeletedSelectedPasswordsPermanentlyFormat"] = "已永久删除选中的 {0} 个密码",
        ["DeletedSelectedRecycleBinItemsPermanentlyFormat"] = "已永久删除选中的 {0} 个项目",
        ...
        ["SaveExportFileFailed"] = "无法保存导出文件。请检查保存位置后重试。",
        ["SaveExportFileFailedFormat"] = "保存导出失败：{0}",
        ["ImportFileSelectionFailed"] = "无法打开导入文件。请检查文件访问权限后重试。",
        ["ImportInvalidFormat"] = "所选文件不是有效的 Monica 导出文件。",
        ["ImportCsvInvalidFormat"] = "所选 CSV 文件未包含受支持的标题行。",
        ["ImportResourceLimitExceeded"] = "导入文件过大或过于复杂，无法安全处理。",
        ["ImportUnexpectedFailure"] = "无法完成导入。请检查文件后重试。",
        ...
        ["MdbxOperationFailed"] = "无法完成 MDBX 操作，请检查连接和本地工作副本后重试。",
        ...
        ["ClearVaultDataFailed"] = "无法清空所选保险库数据，操作已停止，请重试。",
